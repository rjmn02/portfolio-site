...
Github | Demo | Next.js, TypeScript, PostgreSQL, Supabase, Prisma, shadcn/ui, TanStack Table
...
## **Vehicle Management System | Software Developer Intern (Clever Kobweb Remote)**

Github | FastAPI, React, Vite, SQLAlchemy, JWT, TanStack Table
...
Github | NestJS, TypeScript, PostgreSQL, Prisma, Zod Validation
